...
lowlight.registerLanguage('yaml', (await import('highlight.js/lib/languages/yaml.js')).default);
/**
...
export class HtmlPrettyFormatter extends AbstractBatchFormatter {
    ...
    formatData(data, ignoreEmpty = true) {
        if (ignoreEmpty && isEmpty(data)) {
            ...
            const tree = lowlight.highlight('yaml', stringified).children;
